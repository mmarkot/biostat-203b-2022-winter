...
-   [Rule 2.2.4](https://style.tidyverse.org/syntax.html#infix-operators) Place spaces around all infix operators (=, +, -, &lt;-, etc.).  
    ...
    Lines 203-205, 235-237, 264-266, 292 had bad spacing around divide. 
    
    Lines 154-155 had bad spacing around ==
    
    Lines 109, 111, 129 had bad spacing around =. `-16`.
