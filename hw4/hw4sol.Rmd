...
```{r}
mimic_test <- mimic_icu[sample(nrow(mimic_icu), size=100), ]

mimic_test1 <- select(mimic_test, 1, 4, 15:18, 20:21, 39:48, 54:58, 61)

mimic_test1 <- select(mimic_test1, -23)

mimic_icu <- select(mimic_icu, 1, 4, 15:18, 20:21, 39:48, 54:58, 61)
mimic_icu <- select(mimic_test1, -23)
