...
**Solution:** `"$1"`, `"$2"`, and `"$3"` ensure that the entire argument is captured since not having quotes could result in the loss of white space. The first line of the script makes this script compatible with whatever system shell is running the script.
